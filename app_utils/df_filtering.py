...
class FilterState:
    ...
    def filter_col(self, df, col_name, selected_values):
        if selected_values:
...
class FilterUI:
    ...
    def render(self):
        ...
        All logic is handled by filterstate object, and all results are stored there.
        """
        if self.header:
        ...
        for i, col_name in enumerate(self.filter_state.filter_columns):
            ...
            filtered_df = self.filter_state.filter_col(filtered_df, col_name, selected_values)
