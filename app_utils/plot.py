...
def donut_chart(
    ...
    donut_chart = (
        ...
        .configure_title(fontSize=titleFontSize, anchor="middle")
    )
...
def bar_chart(
    ...
    bar_chart = (
        ...
        .encode(
            x=alt.X(
                XcolumnName + xType,
                sort=source[XcolumnName].tolist(),
                axis=alt.Axis(
        ...
        .configure_mark(color=fillColor, width=barWidth)
        .properties(
            height=height,
            width=width,
            title=alt.Title(
                f"{title} | {title_geo}", anchor="middle", fontSize=titleFontSize
            ),
        )
        .interactive()
    )
